    ...
    <nav class="navbar fixed-top nav-custom">
      <div class="container-fluid px-5 py-1">
        <a href="<?php echo base_url() ?>"
          ><img class="logo-nav" src="<?php echo base_url() ?>assets/img/logo1.png" alt=""
        /></a>
        <div>
          <a href="<?php echo base_url() ?>/login"><button class="py-2 shadow rounded-4 ms-4 btn-nav">Log In</button></a>
    ...
    <section class="hero-image mt-5">
      <div class="hero-text">
        ...
        <div class="row">
          <div class="col-4">
            <a href="#"
              ><img src="<?php echo base_url() ?>assets/img/googlePlay.png" alt="" style="width: 15rem"
            /></a>
          </div>
          <div class="col-4">
            <a href="#"
              ><img src="<?php echo base_url() ?>assets/img/appStore.png" alt="" style="width: 15rem"
            /></a>
          </div>
        </div>
      </div>
        ...
        <div class="row">
          <div class="col-3" style="width: 18rem">
            ...
            >
              <img
                style="width: 6rem"
                src="<?php echo base_url() ?>assets/img/iconCepat.png"
          ...
          <div class="col-3" style="width: 18rem">
            ...
            >
              <img
                style="width: 6rem"
                src="<?php echo base_url() ?>assets/img/iconMudah.png"
                class="card-img-top pb-3"
                alt="..."
              />
              <div class="card-body">
          ...
          <div class="col-3" style="width: 18rem">
            ...
            >
              <img
                style="width: 6rem"
                src="<?php echo base_url() ?>assets/img/iconTeknisi.png"
                class="card-img-top pb-3"
                alt="..."
              />
              <div class="card-body">
        ...
        <div class="row">
          <div class="col-3" style="width: 18rem">
            ...
            >
              <img
                style="width: 8rem"
                src="<?php echo base_url() ?>assets/img/iconComp.png"
          ...
          <div class="col-3" style="width: 18rem">
            ...
            >
              <img
                style="width: 8rem"
                src="<?php echo base_url() ?>assets/img/iconPrinter.png"
                class="card-img-top p-3"
                alt="..."
              />
              <div class="card-body">
          ...
          <div class="col-3" style="width: 18rem">
            ...
            >
              <img
                style="width: 8rem"
                src="<?php echo base_url() ?>assets/img/iconWifi.png"
                class="card-img-top p-3"
                alt="..."
              />
              <div class="card-body">
        ...
        <div class="row">
          <div class="col-3" style="width: 18rem">
            ...
            >
              <img
                style="width: 13rem"
                src="<?php echo base_url() ?>assets/img/orangSample.png"
      ...
      <div class="container py-5">
        <div class="row">
          <div class="col d-flex align-items-center">
            <img src="<?php echo base_url() ?>assets/img/logoWhite.png" alt="" style="width: 18rem" class="" />
          </div>
